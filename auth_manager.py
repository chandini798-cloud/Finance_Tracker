...
Handles password hashing (bcrypt / PBKDF2-HMAC-SHA256 with unique salts),
...
class AuthManager:
    ...
    # In-Memory Mock Store for Offline Session Testing
    MOCK_USERS_DB = {}
    ...
    def hash_password(password: str, salt: str = None) -> tuple[str, str]:
        ...
        :param salt: Optional salt hex string.
        :param return: Tuple (password_hash_hex, salt_hex)
        """
        if salt is None:
    ...
    def verify_password(password: str, password_hash: str, salt: str) -> bool:
        """
        Verifies raw password against stored hash and salt using constant-time comparison.
        """
    ...
    def register_user(self, username: str, password: str) -> tuple[bool, str]:
        ...
        # Fallback to In-Memory DB if MySQL is offline
        if conn is None:
